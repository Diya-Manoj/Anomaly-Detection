...
thresh_slider = st.sidebar.slider("Anomaly Threshold (0.01 is usually used)", min_value=0.0, max_value=0.1, value=0.005, step=0.0005)
st.sidebar.markdown("""---
### ℹ️ Model Info
...
if uploaded_file:
    ...
    # Process video
        ...
        for i, (idx, err) in enumerate(anomalies[:len(cols)]):
